...
/>
    ...
    <g id="calendar_add" data-name="calendar add">
      ...
      />
            ...
            <div style={{flex:"1"}}>
            <div style={{width:"30px", height:"30px", borderRadius:"50%",border: "2px solid #00000020", display:"flex", alignItems:"center", justifyContent:"center", position:"relative"}}>
...
</svg>         <TaskStatusOption></TaskStatusOption>
            </div>
            </div>
            <div style={{flex:1}}>
            <div style={{width:"30px", height:"30px", borderRadius:"50%",border: "2px solid #00000020", display:"flex", alignItems:"center", justifyContent:"center",position:"relative"}}>
